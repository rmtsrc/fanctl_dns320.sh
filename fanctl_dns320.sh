...
#
#  Modified by: https://github.com/rmtsrc/fanctl_dns320.sh to provide support for 2x Samsung F4 EcoGreen 2TB 32MB 5400RPM 3.5 Inch SATA-II Internal Hard Drives (HD204UI)
